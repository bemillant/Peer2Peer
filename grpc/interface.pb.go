...
type SkrrrtNumber struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SkrrrtNumber int32 `protobuf:"varint,1,opt,name=skrrrtNumber,proto3" json:"skrrrtNumber,omitempty"`
}

func (x *SkrrrtNumber) Reset() {
	*x = SkrrrtNumber{}
	if protoimpl.UnsafeEnabled {
...
func (x *SkrrrtNumber) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SkrrrtNumber) ProtoMessage() {}

func (x *SkrrrtNumber) ProtoReflect() protoreflect.Message {
	mi := &file_grpc_interface_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SkrrrtNumber.ProtoReflect.Descriptor instead.
func (*SkrrrtNumber) Descriptor() ([]byte, []int) {
	return file_grpc_interface_proto_rawDescGZIP(), []int{1}
}

func (x *SkrrrtNumber) GetSkrrrtNumber() int32 {
	if x != nil {
		return x.SkrrrtNumber
	}
	return 0
}
...
var file_grpc_interface_proto_rawDesc = []byte{
	...
	,
}
...
var file_grpc_interface_proto_goTypes = []interface{}{
	(*Reply)(nil),        // 0: ping.Reply
	(*SkrrrtNumber)(nil), // 1: ping.skrrrtNumber
}
var file_grpc_interface_proto_depIdxs = []int32{
	1, // 0: ping.Ping.passToken:input_type -> ping.skrrrtNumber
	0, // 1: ping.Ping.passToken:output_type -> ping.Reply
